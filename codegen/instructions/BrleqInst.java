...
public class BrleqInst extends BranchInst implements Instruction {
    ...
    public Instruction with_registers(HashMap<String, String> var_reg_map) {
        ...
        return new BrleqInst(params.toArray(new String[params.size()]));
    }
    ...
    public String toString() {
        return String.format("brleq, %s, %s, %s",  this.left, this.right, this.dest);
    }
}
